  ...
  return {
    ...
    writeBundle(options, bundle) {
      ...
      if (configParams.includePublic) {
        const publicDirFiles = _fs.readdirSync.call(void 0, config.publicDir);
        for (const filename of publicDirFiles) {
          console.log("Processing", filename);
          const filePath = _path2.default.join(config.publicDir, filename);
          const data = {
            type: "asset",
            source: new Uint8Array(
              _fs.readFileSync.call(void 0, filePath)
            ),
            fileName: filename,
            name: filename,
